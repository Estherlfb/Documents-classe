...
// let maMusique = ["Jazz", "Blues"]; /* Je crée mon tableau */
// maMusique.push("Rockn'roll");      /*ajouter "rockn'roll" à la fin */ 
// maMusique[Math.floor((maMusique.length - 1) / 2)] = "Classique"; /* remplacer la valeur du milieu par "classique" */
// alert( maMusique.shift()  );  /*supprimer et afficher la première valeur du tableau */
// maMusique.unshift("Rap", "Reggae");   /*ajouter "rap" et "reggae" au début du tableau */
...
//         if (typeof nombre === null || nombre === "" || isFinite(nombre)) break; {
//             nombre.push(+nombre);
//         }

//         let total = 0;
//         for (let chiffre in nombre) {
//             total += chiffre
//         } return total;
//     }

//     let resultat = chiffre.reduce((total, nombre) => total + nombre, 0 /*départ de l'accumulateur */);



//Fonction camelize qui enlève les "-" et met les premières lettre en maj
// function camelize(str){
//     let words = str.split("-"); /*On enlève les "-" */
//     let wordsIndex = words.map(function(word, index){
//         if(index == 0){
//             return word,
//         }else{
//             let capitalPremiereLettre = word[0].toUpperCase();
//             let capitalMot = capitalPremiereLettre + word.slice(1);
//             return capitalMot;
//         }
//     })
//     let camelizedString = wordsIndex.join('');
...
// let filtered = filterRange(arr, 1, 4); /* appel à la fonction */
// alert (filtered);

// function filtered(arr, min, max){
//     return arr.filter(value => (value >= min && value <= max))
// }


// function moyenneAge(arr){
//     return arr.reduce((somme, user) => somme + user.age, 0)/arr.length;
// }
...
//     // methode 2 div.style.top = obj.top;
//     // methode 2 div.style.right = obj.right;
//     // methode 2 div.innerHTML = obj.html;
//     // methode 2 div.className = "notification" + ((obj.className) ? " "+obj.className : '');
//     div.classList.add('notification');
//     notification.className = "welcome";
//     div.createTextNode('Hello !');
//     document.getElementById('notification').style.top = "10px"; /*div.style.top = "10px"; */
//     document.getElementById('notification').style.right = "10px"; /*div.style.right = "10px"; */
// }
